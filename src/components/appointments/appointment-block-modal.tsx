    ...
    try {
      ...
      for (let i = 0; i < slots.length; i++) {
        ...
        const queryObj = {
          ...
          notes: `${formData.reason ? `Motivo: ${formData.reason}` : ""}${blockType === "fullday" ? "Dia inteiro bloqueado" : "Bloqueio de período específico"}${isRecurring ? ` (Recorrência: ${recurrenceType === "daily" ? "Diária" : "Semanal"})` : ""}.`,
          ...(blockType === "fullday" && { 
            full_day: true,
