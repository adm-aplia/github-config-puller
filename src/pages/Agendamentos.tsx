                ...
                <div className="w-full">
                  <Calendar
                    ...
                    classNames={{
                      ...
                      cell: "flex-1 w-full text-center p-0 relative border-r border-b border-border/20 [&:has([aria-selected])]:bg-accent first:[&:has([aria-selected])]:rounded-l-md last:[&:has([aria-selected])]:rounded-r-md focus-within:relative focus-within:z-20",
                      day: "w-full p-0 font-normal bg-transparent text-foreground aria-selected:opacity-100 [&:has([aria-selected])]:bg-primary text-foreground rounded-0 hover:bg-accent/50 transition-colors flex flex-col items-center justify-start",
                      day_range_end: "day-range-end",
                      day_selected: "bg-primary text-primary-foreground hover:bg-primary hover:text-primary-foreground focus:bg-primary focus:text-primary-foreground",
                      day_today: "bg-accent text-accent-foreground",
                      day_outside: "text-muted-foreground opacity-50 aria-selected:bg-accent/50 aria-selected:text-muted-foreground aria-selected:opacity-30",
                      day_disabled: "text-muted-foreground opacity-50",
                      day_range_middle: "aria-selected:rounded-none aria-selected:bg-accent aria-selected:text-accent-foreground",
